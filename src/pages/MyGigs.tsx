    ...
    <div className="min-h-screen bg-(--color-bg) py-8 px-4" dir={direction}>
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex justify-between items-center mb-8">
          <h1 className="text-3xl font-bold text-(--color-text)">{t("myGigs.title")}</h1>
          <Link
            to="/create-gig"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="bg-(--color-surface) rounded-lg p-6 shadow-md">
            <div className="text-(--color-text-muted) mb-2">{t("myGigs.total")}</div>
            <div className="text-3xl font-bold text-(--color-text)">
              {gigs.length}
            </div>
          </div>
          <div className="bg-(--color-surface) rounded-lg p-6 shadow-md">
            <div className="text-(--color-text-muted) mb-2">{t("myGigs.active")}</div>
            <div className="text-3xl font-bold text-green-600">
              {gigs.filter((g) => g.is_active).length}
            </div>
          </div>
          <div className="bg-(--color-surface) rounded-lg p-6 shadow-md">
            <div className="text-(--color-text-muted) mb-2">{t("myGigs.totalOrders")}</div>
              ...
              >
                ...
                <div className="relative">
                  ...
                  <div className="absolute top-2 right-2">
                    ...
                    >
                      {gig.is_active ? t("myGigs.activeStatus") : t("myGigs.inactiveStatus")}
                    </span>
                  </div>
                </div>
