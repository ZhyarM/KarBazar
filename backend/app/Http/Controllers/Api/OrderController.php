...
class OrderController extends Controller
{
    ...
    public function updateStatus(Request $request, $id)
    {
        ...
        if ($request->status === 'completed') {
            ...
            $seller->profile->increment('total_earnings', $order->seller_earnings);
        }
    ...
    public function acceptDelivery(Request $request, $id)
    {
        ...
        // Update stats with seller earnings (not full price)
        $order->seller->profile->increment('total_jobs');
        $order->seller->profile->increment('total_earnings', $order->seller_earnings);
